...
def SurroundingCells(rand_wall,grid):
...
def Prims_maze(maze_start,grid,grid_wrapper):
    ...
    while(walls):
        ...
        if rand_wall[1] != 0 and rand_wall[1] != width -1:
            if grid[rand_wall[0]][rand_wall[1]-1].is_visited == False and grid[rand_wall[0]][rand_wall[1]+1].is_active == True: #
                # Find the number of surrounding cells
                s_cells = SurroundingCells(rand_wall,grid)
                ...
                if s_cells < 2:
                    ...
                    # Upper cell
                    if rand_wall[0] != 0:
                        if grid[rand_wall[0]-1][rand_wall[1]].is_active != True or grid[rand_wall[0]-1][rand_wall[1]].is_visited == False: #
                    ...
                    # Leftmost cell
                    if rand_wall[1] != 0:	
                        if grid[rand_wall[0]][rand_wall[1]-1].is_active != True or grid[rand_wall[0]][rand_wall[1]-1].is_visited == False: #
        ...
        if rand_wall[0] != 0 and rand_wall[0] != height - 1:
            if grid[rand_wall[0]-1][rand_wall[1]].is_visited == False and grid[rand_wall[0]+1][rand_wall[1]].is_active == True:
                ...
                if s_cells < 2:
                    ...
                    # Upper cell
                    if rand_wall[0] != 0:
                        if grid[rand_wall[0]-1][rand_wall[1]].is_active == False or grid[rand_wall[0]-1][rand_wall[1]].is_visited == False:
                            grid[rand_wall[0]-1][rand_wall[1]].is_active = False
                            grid[rand_wall[0]-1][rand_wall[1]].is_visited = True
                        if [rand_wall[0]-1, rand_wall[1]] not in walls:
                            walls.append([rand_wall[0]-1, rand_wall[1]])
                    ...
                    # Leftmost cell
                    if rand_wall[1] != 0:
                        if grid[rand_wall[0]][rand_wall[1]-1].is_active == False or grid[rand_wall[0]][rand_wall[1]-1].is_visited == False:
                            grid[rand_wall[0]][rand_wall[1]-1].is_active = False
                            grid[rand_wall[0]][rand_wall[1]-1].is_visited = True
                        if [rand_wall[0], rand_wall[1]-1] not in walls:
                            walls.append([rand_wall[0], rand_wall[1]-1])
